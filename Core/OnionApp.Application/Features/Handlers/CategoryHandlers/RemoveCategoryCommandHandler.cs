...
{
    public class RemoveCategoryCommandHandler(IRepository<Category> _repository,IUnitOfWork _unitOfWork) : IRequestHandler<RemoveCategoryCommand, BaseResult<object>>
    {
        public async Task<BaseResult<object>> Handle(RemoveCategoryCommand request, CancellationToken cancellationToken)
        {
            ...
            return result
                ...
                : BaseResult<object>.Fail("Kategori silinemedi");
