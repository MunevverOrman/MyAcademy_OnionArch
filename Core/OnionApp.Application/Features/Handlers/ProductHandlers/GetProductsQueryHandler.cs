...
{
    public class GetProductsQueryHandler(IRepository<Product> _repository)
        : IRequestHandler<GetProductsQuery, BaseResult<List<GetProductsQueryResult>>>
    {
        public async Task<BaseResult<List<GetProductsQueryResult>>> Handle(
