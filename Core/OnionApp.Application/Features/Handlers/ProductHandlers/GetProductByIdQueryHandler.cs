...
using OnionApp.Application.Features.Handlers.ProductHandlers;
...
namespace OnionApp.Application.Features.Handlers.ProductHandlers
{
    ...
    : IRequestHandler<GetProductByIdQuery, BaseResult<GetProductByIdQueryResult>>
    {
        public async Task<BaseResult<GetProductByIdQueryResult>> Handle(
